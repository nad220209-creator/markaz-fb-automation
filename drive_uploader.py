...
def get_drive_service():
    ...
    try:
        ...
        print(f"Error parsing Google Drive credentials or building service: {e}")
        return None
...
def upload_product_to_drive(product_data, local_images, details_content, date_str):
    ...
    if not service:
        print("Skipping Google Drive upload due to missing service.")
        return
    ...
    try:
        ...
        print(f"Successfully uploaded folder and files for: {product_data['title']}")
    except Exception as e:
